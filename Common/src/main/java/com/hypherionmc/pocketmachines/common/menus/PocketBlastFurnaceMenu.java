...
public class PocketBlastFurnaceMenu extends AbstractPocketFurnaceMenu {
    ...
    public PocketBlastFurnaceMenu(int containerId, Inventory playerInventory) {
        super(ModContainers.BLAST_FURNACE.get(), RecipePropertySet.BLAST_FURNACE_INPUT, RecipeBookType.BLAST_FURNACE, containerId, playerInventory);
    }

    public PocketBlastFurnaceMenu(int containerId, Inventory playerInventory, Container container, ContainerData containerData) {
        super(ModContainers.BLAST_FURNACE.get(), RecipePropertySet.BLAST_FURNACE_INPUT, RecipeBookType.BLAST_FURNACE, containerId, playerInventory, container, containerData);
    }
