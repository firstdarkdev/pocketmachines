...
public class AbstractPocketFurnaceScreen<T extends AbstractPocketFurnaceMenu> extends AbstractFurnaceScreen<T> {
    ...
    public AbstractPocketFurnaceScreen(T menuType, AbstractFurnaceRecipeBookComponent recipeBookComponent, Inventory playerInventory, Component name, ResourceLocation texture) {
        super(menuType, recipeBookComponent, playerInventory, name, texture);
    }
